...
namespace AdministratorStore
{
    ...
    class Shop
    {
        ...
        public void ServiceClients()
        {
            ...
            for (int i = 0; i < numberClients; i++)
            {
                ...
                AmountSellProduct(client);
            }
        }

        public void AmountSellProduct(Client client)
        {
            bool isBuy = true;
            ...
            while (isBuy == true)
            {
                ...
                {
                    amountCostProducts = client.RemoveProduct(amountCostProducts);
    ...
    class Client
    {
        ...
        public int RemoveProduct(int amountCost)
        {
